...
const About = () => {
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      {/* <h1 className="text-3xl font-bold mb-4 text-slate-800">House</h1> */}

      <h1 className="font-bold text-3xl flex flex-wrap mb-4">
        <span className="text-slate-500">House </span>&nbsp;
        <span className="text-slate-700">ForYou</span>
      </h1>
      <p className="mb-4 text-slate-700">
        House For You is a leading real estate agency that specializes in
